...
public class SQLConstants {
    ...
    public static final String INSERT_USER = "insert into users(login, email, firstName, lastName, password) values(?,?,?,?,?)";
    ...
    public static final String WHERE_CONF_BY_USER = "where id = ?";
