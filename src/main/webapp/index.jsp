...
<html>
<head>
    <jsp:include page="settingsPages.jsp"></jsp:include>
    ...
    <header class="p-3 text-bg-dark">
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <!-- Лого сайта -->
          <a href='<c:url value = "/index.jsp"/>' class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
